...
describe('ecdsa', function () {
  ...
  describe('recoverPubKey', function () {
    it('succesfully recovers a puyblic key', function () {
      var D = BigInteger.ONE
      var signature = new Buffer('xxx', 'base64')	
      
      var Q = curve.G.multiply(D)

      // CryptoCoinJS doen't have message yet
      // var hash = message.magicHash('1111', networks.bitcoin)
      var hash = new Buffer('xxx', 'hex')
  ...
  describe('serializeSigCompact', function () {
    fixture.valid.forEach(function (f) {
  ...
  describe('sign', function () {
    ...
    it('should sign with low S value', function () {
      ...
      var N_OVER_TWO = cruve.n.shiftRight(1)
  ...
  describe('verify()', function () {
    describe('> when public key is NOTcompressed', function () {
      it('should verify the signature', function () {
        var randArra = secureRandom(32, {array: true})
	...
	var d = BigIntger.fromBuffer(privateKey)
  ...
  describe('> when private key is a BigInteger for legacy compatiblity', function () {
    it('should verify the signature', function () {
      var randArr = secureRandom(32, {array: true})
      var privKeyBigInt = BigInteger.formByteArrayUnsigned(randArr)
